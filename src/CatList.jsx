import './AnimalList.css'; // use the new unified CSS file
    ...
    <section className="animal-list">
      ...
      <div className="animal-cards">
        ...
        <div className="animal-card">
          ...
          <p className="tagline">Quiet and sweet, with a love for cozy spots.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
        ...
        <div className="animal-card">
          ...
          <h3>Lily</h3>{' '}
          <p>
            <strong>Breed:</strong> Devon Rex
          </p>{' '}
          <p>
            <strong>Age:</strong> 5 years
          </p>{' '}
          <p>
            <strong>Location:</strong> Chandigarh
          </p>{' '}
          <p className="tagline">Playful and mischievous, always full of surprises.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
        ...
        <div className="animal-card">
          ...
          <h3>Oscar</h3>{' '}
          <p>
            <strong>Breed:</strong> Turkish Van
          </p>{' '}
          <p>
          ...
          <p className="tagline">Loves water and adventure, a unique feline friend.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
        ...
        <div className="animal-card">
          {' '}
          <img src="https://cdn.britannica.com/95/46495-004-6141F577.jpg" alt="Manx Cat" />{' '}
          <h3>Felix</h3>{' '}
          <p>
            <strong>Breed:</strong> Manx
          </p>{' '}
          <p>
            <strong>Age:</strong> 3.5 years
          </p>{' '}
          <p>
            <strong>Location:</strong> Bengaluru, Karnataka
          </p>{' '}
          <p className="tagline">Cheerful and friendly, perfect for families.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
        ...
        <div className="animal-card">
          ...
          <p className="tagline">Gentle and loving, a true lap cat.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
        ...
        <div className="animal-card">
          ...
          <p className="tagline">Social and playful, loves to be around people.</p>{' '}
          <div className="animal-card-buttons">
            {' '}
            <Link to="/adoption-form" className="btn adopt-btn">
              Adopt Now
