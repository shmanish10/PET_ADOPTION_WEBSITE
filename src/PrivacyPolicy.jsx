...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-section">
      ...
      <p>
        {" "}
        Welcome to <strong>PetAdoption</strong>! Your privacy is important to
      ...
      <ul>
        ...
        <li>
          ...
          number, and other contact details when you register or submit adoption
          inquiries.{" "}
        </li>{" "}
        <li>
          {" "}
      ...
      <ul>
        ...
        <li>
          To send updates, newsletters, or promotional content (if subscribed).
        </li>{" "}
      ...
      <ul>
        {" "}
        <li>
          Trusted third-party service providers assisting in website operations.
        </li>{" "}
      ...
      <p>
        {" "}
        We use cookies to improve user experience. You can adjust your browser
        settings to disable cookies if you prefer.{" "}
      </p>{" "}
      <h2>5. Data Security</h2>{" "}
      <p>
        {" "}
        We take necessary security measures to protect your personal
      ...
      <p>
        ...
        Contact us at <strong>support@petadoption.com</strong> for any
